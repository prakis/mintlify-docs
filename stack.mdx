...
<img
  src="/images/Tallrik_-_Ystad-2018.jpg"
  alt="Tallrik_-_Ystad-2018.jpg"
  title="Tallrik_-_Ystad-2018.jpg"
  className="mx-auto"
  style={{ width:"22%" }}
/>
...
2. Another good usecase is Navigating backward in a browser.  Every website you visit added to the browser history stack.

[https://en.wikipedia.org/wiki/Stack\_(abstract_data_type)](https://en.wikipedia.org/wiki/Stack\_\(abstract_data_type\))